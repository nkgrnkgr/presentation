...
- CustomEventの設計・型・テスト: [型とテストで守るカスタムイベント通信 - 実プロダクトでの実装事例](https://kakehashi-dev.hatenablog.com/entry/2025/08/12/110000)
- 開発環境（Chrome拡張でのJS/CSS差し替え ほか）: [生成AIで内部ツール開発のジレンマを解決する](https://kakehashi-dev.hatenablog.com/entry/2025/07/29/140000)
